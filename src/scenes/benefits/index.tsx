                ...
                <div className="mt-16 md:flex items-center justify-between gap-20 md:mt-28">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <motion.div className="before:absolute before:content-abstractwaves before:-top-20 before:-left-20 before:z-[-1]"
                                initial="hidden"
                                whileInView="visible"
                                viewport={{ once: true, amount: 0.5 }}
                                transition={{ duration: 0.5 }}
                        ...
                        <div className="relative mt-16">
                            <div className="before:absolute before:content-sparkles before:right-40 before:-bottom-20 before:z-[-1]">
                                <ActionButton
                                    setSelectedPage={setSelectedPage}
                                >
                                    Join Now
